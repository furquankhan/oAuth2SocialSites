...
namespace reflections.ilb.entity.Base
{
	[Serializable]
	public partial class ILBBaseEntity : IDisposable
	{
		#region variables
		[XmlIgnore]
		[SoapIgnore]
		...
		/// </summary>
		public ILBBaseEntity CloneUnproxied()
		{
			Type entityType = this.GetType();
			
			// new close instance
			var cloneEntity = (ILBBaseEntity)Activator.CreateInstance(entityType);
		...
		/// Creates an unproxied copy of the entity to the specified destination model, according to DataMember flag.
		/// </summary>
		public void CopyUnproxied(object destinationModel)
		{
			Type entityType = this.GetType();
